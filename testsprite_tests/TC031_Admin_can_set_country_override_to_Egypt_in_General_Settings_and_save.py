...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to the admin login page at /admin/login (http://localhost:3000/admin/login).
        await page.goto("http://localhost:3000/admin/login", wait_until="commit", timeout=10000)
        
        # -> Fill the password field with the test password and click 'Log in' to attempt authentication.
