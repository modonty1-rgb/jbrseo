// Fix: hero copy shouldn't say "سعودي" (exclusive) — clients are Saudi + Egyptian
...
const res = await db.collection('LandingSection').updateOne(
  { section: 'hero' },
  { $set: {
    'data.h1Line1': 'شركاؤكم في البحث والذكاء الاصطناعي',
    'data.h1Line2': 'اشتراك محتوى شهري · بدون إعلانات · بدون فريق داخلي',
    'data.sub':     'فريق عربي يكتب وينشر ويحسّن محتواك للبحث و ChatGPT و Perplexity — أنت تركّز على البيع.',
    'data.proof':   '{clientCount} علامة تجارية سعودية وعربية تنمو معنا — امتى دورك؟',
    updatedAt: new Date(),
  } },
);
