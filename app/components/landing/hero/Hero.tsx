    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        <div className="hero-content-reveal w-full">
          ...
          <div className="mt-2 grid w-full grid-cols-1 gap-8 xl:mt-0 xl:grid-cols-2 xl:items-center xl:gap-12">
            <div className="order-1 flex w-full min-w-0 flex-col items-center gap-4 xl:order-1 xl:items-start xl:gap-5">
              <HeroHeadline line1={h.h1Line1} line2={h.h1Line2} />
              <HeroSlogan tagline={staticLanding.footer.tagline} />
              <div className="mt-3 flex flex-col items-center gap-3 xl:items-start">
                <Link
                  href={ctaLink}
            ...
            <div className="order-2 flex w-full min-w-0 justify-center xl:order-2">
              <HeroBrandTag />
            </div>
          </div>
          <p
            id="hero-description"
            className="landing-hero-sub landing-reveal-content mx-auto mt-4 mb-4 max-w-[490px] text-base font-normal leading-[1.85] text-foreground/75 sm:text-[17.5px] xl:mt-6"
          >
            {h.sub}
          </p>
