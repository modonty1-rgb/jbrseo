...
export function AnnouncementBar({ message }: { message: string }) {
  ...
  return (
    <div
      role="status"
      className="relative flex flex-wrap items-center justify-center gap-x-[14px] gap-y-1 ps-[var(--tap)] pe-4 py-[10px] text-[13px] sm:text-[13.5px] font-medium text-white text-center bg-[#0A0A0A]"
    >
      <span
        className="font-bold text-[10.5px] text-white bg-[#0E9F6E] py-[3px] px-[7px] rounded-[4px] tracking-[0.5px]"
