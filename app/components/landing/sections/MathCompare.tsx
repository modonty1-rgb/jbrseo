...
import { CalcSavingsButton } from "./CalcSavingsButton";
 ...
 * server; the only interactive leaf (the savings button + its lazy modal) lives
 * in the CalcSavingsButton client island.
 */
    ...
    <section className="bg-background">
        <div className="max-w-270 mx-auto px-7 py-8 md:py-14">
          ...
          <div className="text-center mb-5 md:mb-8">
            ...
            <h2 className="text-balance text-[clamp(20px,5.6vw,36px)] font-semibold tracking-[-1px] mb-3">
