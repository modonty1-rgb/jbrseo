        ...
        <div className="flex flex-wrap items-center justify-between gap-2 px-5 py-2  sm:px-8 lg:px-10">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            <a
              ...
              className="hidden items-center gap-1.5 rounded-full border border-border/50 px-3 py-1.5 text-xs font-bold text-muted-foreground/80 transition-colors hover:border-[#25D366]/50 hover:text-foreground lg:flex"
              dir="ltr"
              aria-label="تواصل عبر واتساب"
            >
              <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-[#25D366]" xmlns="http://www.w3.org/2000/svg" aria-hidden>
