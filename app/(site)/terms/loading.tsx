...
/**
 * Mirrors app/(site)/terms/page.tsx structure 1:1 to eliminate layout shift
 * between skeleton → content. Same container widths, sections, spacing.
 * Terms has ~13 sections vs privacy's ~12 — using 10 skeleton cards as a
 * reasonable proxy.
 */
