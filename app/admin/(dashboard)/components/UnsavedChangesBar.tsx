...
export function UnsavedChangesBar({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-x-0 z-50 mx-auto flex w-fit max-w-[calc(100vw-2rem)] items-center gap-3 rounded-lg border border-border bg-card px-4 py-2 text-sm shadow-lg bottom-4",
        className,
      )}
      role="status"
    >
